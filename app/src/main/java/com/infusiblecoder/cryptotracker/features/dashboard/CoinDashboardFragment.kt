...
import com.infusiblecoder.cryptotracker.features.coinsearch.CoinSearchActivity
...
import com.infusiblecoder.cryptotracker.databinding.FragmentDashboardBinding
...
class CoinDashboardFragment : Fragment(), CoinDashboardContract.View {
    ...
    private val dashboardRepository by lazy {
        DashboardRepository(MyApplication.database)
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding.toolbar?.title = getString(R.string.market)
    ...
    private fun initializeUI(inflatedView: FragmentDashboardBinding) {
                    ...
                    is ShortNewsItemView.ShortNewsModuleData -> shortNewsItemView {
                        ...
                        itemClickListener { _ ->
                            moduleItem.news.url?.let {
                                ...
                                CryptoTrackerCache.updateCryptoCompareNews(moduleItem.news)
                                coinDashboardPresenter.getLatestNewsFromCryptoCompare()
                            }
                        }
                    }
    ...
    override fun onNetworkError(errorMessage: String) {
        ...
        try {
            Snackbar.make(rvDashboard, errorMessage, Snackbar.LENGTH_SHORT).show()
        }catch (e:Exception){
